...
PanelWindow {
    ...
    readonly property string launcherIconText: "\ue7d9"
    readonly property string launcherIconFont: "JetBrainsMono Nerd Font Propo"
        ...
        Item {
            ...
            Row {
                ...
                Rectangle {
                    ...
                    opacity: 0.5
                    anchors.verticalCenter: parent.verticalCenter
                    visible: openWindows.shownWindows.length > 0
                }

                Windows {
                    id: openWindows
                    anchors.verticalCenter: parent.verticalCenter
                    // Empty => show windows from every output (both monitors).
                    screenName: ""
                    theme: ({
                        fg: root.fg,
                        accent: root.accent,
