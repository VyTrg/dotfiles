...
PanelWindow {
    ...
    property string sysOsName:         "Linux"
    property string sysOsVersion:      ""
    ...
    Process {
        ...
        command: ["bash", "-lc",
            ...
            "osname=$(. /etc/os-release 2>/dev/null; echo \"${NAME:-Linux}\"); " +
            "oversion=$(. /etc/os-release 2>/dev/null; echo \"$VERSION_ID\"); " +
        ...
        onExited: {
            ...
            root.sysOsName         = values.OS       || "Linux"
            root.sysOsVersion      = values.OVERSION || ""
            ...
            Item {
                ...
                GridLayout {
                    ...
                    SysInfoBlock {
                        ...
                        rows: [
                            { k: "OS",       v: root.sysOsName         || "Linux" },
                            { k: "Version",  v: root.sysOsVersion      || "—" },
